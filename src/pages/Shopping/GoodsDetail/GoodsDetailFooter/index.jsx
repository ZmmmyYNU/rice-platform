      ...
      <div className="footer">
        ...
        <div className="font-items">
          <div className="font-item">
            {isGuzhang ? (
              <i
                className="iconfont icon-dianzan active-red"
                onClick={ChangeGuzhangNumber}
              ></i>
            ) : (
              <i
            ...
            <div className="font-number">
              {guzhangNumber ? guzhangNumber : "点赞"}
            </div>
          </div>
          <div className="font-item">
            {isShoucang ? (
              <i
                className="iconfont icon-shoucang active-red"
                onClick={ChangeShoucangNumber}
              ></i>
            ) : (
              <i
            ...
            <div className="font-number">
              {shoucangNumber ? shoucangNumber : "收藏"}
            </div>
          </div>
          <div className="font-item">
            <i className="iconfont icon-pinglun"></i>
            <div className="font-number">
              {commentNumber ? commentNumber : "评论"}
            </div>
          </div>
        </div>
      </div>
